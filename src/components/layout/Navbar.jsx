        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <a href="#hero" className="flex items-center gap-2.5 group">
              ...
              <span className={`text-xl font-bold font-heading tracking-tight ${isScrolled ? 'text-theme-main' : 'text-white'}`}>
                Edu<span className={isScrolled ? 'text-theme-primary' : 'text-theme-accent'}>Pulse</span>
              </span>
            </a>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-6 py-6 space-y-4">
              <div className="flex flex-col space-y-3">
                {navLinks.map((link) => (
                  <a
                    ...
                    className="text-base font-semibold text-theme-main hover:text-theme-primary py-2 border-b border-theme-subtle"
                  >
                    {link.name}
                  </a>
                ))}
              ...
              <div className="pt-2">
                <span className="text-xs font-bold font-heading text-theme-muted uppercase tracking-wider block mb-2">
                  Select Visual Style
                </span>
                  ...
                  {themesList.map((t) => (
                    <button
                      ...
                      className={`p-2.5 rounded-xl border text-left flex items-center gap-2 transition-all ${
                        themeKey === t.id
                          ? 'border-theme-primary bg-theme-surface-alt font-bold'
                    ...
                    >
                      ...
                      <span className="text-xs font-heading text-theme-main">{t.name}</span>
                    </button>
                  ))}
                </div>
              </div>
